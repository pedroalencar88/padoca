object FRMVENDA: TFRMVENDA
  ...
  object QVALIDACPF: TFDQuery
    ...
    SQL.Strings = (
      '--SELECT REPLACE(REPLACE(cpf,'#39'-'#39','#39#39'),'#39'.'#39','#39#39') AS CPF FROM CLIENTE'
      '--WHERE CPF = :CPF'
      ''
      'SELECT * FROM CLIENTE'
      'WHERE CPF = :CPF')
    ...
    object QVALIDACPFcodigo_cliente: TFDAutoIncField
      FieldName = 'codigo_cliente'
      Origin = 'codigo_cliente'
      ProviderFlags = [pfInWhere, pfInKey]
      ReadOnly = True
    end
    object QVALIDACPFdata_nasc: TSQLTimeStampField
      FieldName = 'data_nasc'
      Origin = 'data_nasc'
      Required = True
    end
    object QVALIDACPFfone: TStringField
      FieldName = 'fone'
      Origin = 'fone'
      Required = True
      Size = 25
  ...
  object QBUSCAPRODUTO: TFDQuery
    ...
    object QBUSCAPRODUTOcodigo_produto: TFDAutoIncField
      FieldName = 'codigo_produto'
      Origin = 'codigo_produto'
      ProviderFlags = [pfInWhere, pfInKey]
      ReadOnly = True
    end
    object QBUSCAPRODUTOdescricao: TStringField
      FieldName = 'descricao'
      Origin = 'descricao'
      Required = True
      Size = 50
    ...
    object QBUSCAPRODUTOqtde: TIntegerField
      FieldName = 'qtde'
      Origin = 'qtde'
      Required = True
    end
  ...
  object GRAVARVENDA: TFDQuery
    ...
    SQL.Strings = (
        ...
        'INSERT INTO VENDA (funcionario,cliente,data_venda,valortotal) VA' +
        'LUES (:FUNCIONARIO, :CLIENTE, GETDATE(), :VALORTOTAL)')
    Left = 392
    Top = 392
    ParamData = <
      item
  ...
  object GRAVARITEM_VENDA: TFDQuery
    ...
    SQL.Strings = (
        ...
        'INSERT INTO ITEM_VENDA (venda,nritem,produto,qtde) VALUES ((SELE' +
        'CT MAX(codigo_venda) FROM VENDA), :nritem, :produto, :qtde)')
    Left = 304
    Top = 392
    ParamData = <
      item
